...
const buttonMore = document.querySelector('.auto-button');
const moreAuto = document.querySelectorAll('.more-auto');
buttonMore.onclick = () => {
  moreAuto.forEach (item => item.style.display == 'none' ? item.style.display = 'block' : item.style.display = 'none'
  )};
